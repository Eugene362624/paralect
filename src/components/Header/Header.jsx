...
function Header(props) {
    ...
    const getDataFromGitHub = (e) => {
        e.preventDefault()
        dispatch(infoUser(userName))
        dispatch(infoRepos(userName))
    }
    return (
        <header>
            <svg id="logo" width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="input">
                <form onSubmit={(e) => getDataFromGitHub(e)}>
                ...
                <input minLength="1" required onChange={e => setUserName(e.target.value)} type="text" placeholder="Enter GitHub username" />
                </form>
            </div>
        </header>
    )
